 ...
 * @copyright CiviCRM LLC (c) 2004-2013
 *
 * Generated from xml/schema/CRM/Accountsync/AccountLineItems.xml
 * DO NOT EDIT.  Generated by GenCode.php
 */
require_once 'CRM/Core/DAO.php';
require_once 'CRM/Utils/Type.php';
class CRM_Accountsync_DAO_AccountLineItems extends CRM_Core_DAO
{
  /**
   ...
   * @static
   */
  static $_tableName = 'civicrm_accountlineitems';
  /**
   ...
   *
   * @access public
   * @return civicrm_accountlineitems
   */
  function __construct()
  {
    $this->__table = 'civicrm_accountlineitems';
    parent::__construct();
  }
  /**
    ...
    if (!(self::$_import)) {
      ...
      foreach($fields as $name => $field) {
        if (CRM_Utils_Array::value('import', $field)) {
          if ($prefix) {
            self::$_import['accountlineitems'] = & $fields[$name];
          } else {
    ...
    if (!(self::$_export)) {
      ...
      foreach($fields as $name => $field) {
        if (CRM_Utils_Array::value('export', $field)) {
          if ($prefix) {
            self::$_export['accountlineitems'] = & $fields[$name];
          } else {
