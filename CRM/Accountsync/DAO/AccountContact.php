 ...
 *
 * Generated from /home/dev/civicrm/civicrm-buildkit/build/dmaster/sites/default/files/civicrm/ext/nz.co.fuzion.accountsync/xml/schema/CRM/Accountsync/AccountContact.xml
 * DO NOT EDIT.  Generated by CRM_Core_CodeGen
 * (GenCodeChecksum:1fd33b1402669481fd45a35815277762)
 */
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        'id' => [
          ...
          'description' => CRM_Accountsync_ExtensionUtil::ts('Unique AccountContact ID'),
          'required' => TRUE,
        ...
        'contact_id' => [
          'name' => 'contact_id',
          'type' => CRM_Utils_Type::T_INT,
          'description' => CRM_Accountsync_ExtensionUtil::ts('FK to Contact'),
        ...
        'accounts_contact_id' => [
          ...
          'description' => CRM_Accountsync_ExtensionUtil::ts('External Reference'),
          'maxlength' => 128,
        ...
        'accounts_display_name' => [
          ...
          'type' => CRM_Utils_Type::T_STRING,
          'title' => CRM_Accountsync_ExtensionUtil::ts('Display Name'),
          'description' => CRM_Accountsync_ExtensionUtil::ts('Name from Accounts Package'),
          'maxlength' => 128,
          'size' => CRM_Utils_Type::HUGE,
        ...
        'last_sync_date' => [
          ...
          'title' => CRM_Accountsync_ExtensionUtil::ts('Last Sync Date'),
          'description' => CRM_Accountsync_ExtensionUtil::ts('When was the contact last synced.'),
        ...
        'accounts_modified_date' => [
          ...
          'type' => CRM_Utils_Type::T_TIMESTAMP,
          'title' => CRM_Accountsync_ExtensionUtil::ts('Accounts Modified Date'),
          'description' => CRM_Accountsync_ExtensionUtil::ts('When was the invoice last Altered in the accounts system.'),
        ...
        'accounts_data' => [
          ...
          'title' => CRM_Accountsync_ExtensionUtil::ts('Account System Data'),
          'description' => CRM_Accountsync_ExtensionUtil::ts('json array of data as returned from accounts system'),
        ...
        'error_data' => [
          'name' => 'error_data',
          'type' => CRM_Utils_Type::T_TEXT,
          'title' => CRM_Accountsync_ExtensionUtil::ts('Account Error Data'),
          'description' => CRM_Accountsync_ExtensionUtil::ts('json array of error data as returned from accounts system'),
        ...
        'accounts_needs_update' => [
          ...
          'title' => CRM_Accountsync_ExtensionUtil::ts('Accounts Needs Update'),
          'description' => CRM_Accountsync_ExtensionUtil::ts('Include in next push to accounts'),
        ...
        'connector_id' => [
          'name' => 'connector_id',
          'type' => CRM_Utils_Type::T_INT,
          'description' => CRM_Accountsync_ExtensionUtil::ts('ID of connector. Relevant to connect to more than one account of the same type'),
        ...
        'plugin' => [
          'name' => 'plugin',
          'type' => CRM_Utils_Type::T_STRING,
          'title' => CRM_Accountsync_ExtensionUtil::ts('Account Plugin'),
          'description' => CRM_Accountsync_ExtensionUtil::ts('Name of plugin creating the account'),
          'maxlength' => 32,
        ...
        'do_not_sync' => [
          'name' => 'do_not_sync',
          'type' => CRM_Utils_Type::T_BOOLEAN,
          'title' => CRM_Accountsync_ExtensionUtil::ts('Do Not Sync'),
          'description' => CRM_Accountsync_ExtensionUtil::ts('Do not sync this contact'),
