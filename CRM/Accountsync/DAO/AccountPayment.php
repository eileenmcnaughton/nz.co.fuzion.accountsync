 ...
 * @copyright CiviCRM LLC (c) 2004-2013
 *
 * Generated from xml/schema/CRM/Accountsync/AccountPayment.xml
 * DO NOT EDIT.  Generated by GenCode.php
 */
require_once 'CRM/Core/DAO.php';
require_once 'CRM/Utils/Type.php';
class CRM_Accountsync_DAO_AccountPayment extends CRM_Core_DAO
{
  /**
   ...
   * @static
   */
  static $_tableName = 'civicrm_accountpayment';
  /**
   ...
   *
   * @access public
   * @return civicrm_accountpayment
   */
  function __construct()
  {
    $this->__table = 'civicrm_accountpayment';
    parent::__construct();
  }
  /**
    ...
    if (!(self::$_import)) {
      ...
      foreach($fields as $name => $field) {
        if (CRM_Utils_Array::value('import', $field)) {
          if ($prefix) {
            self::$_import['accountpayment'] = & $fields[$name];
          } else {
    ...
    if (!(self::$_export)) {
      ...
      foreach($fields as $name => $field) {
        if (CRM_Utils_Array::value('export', $field)) {
          if ($prefix) {
            self::$_export['accountpayment'] = & $fields[$name];
          } else {
